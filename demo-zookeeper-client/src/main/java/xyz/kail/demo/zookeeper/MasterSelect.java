...
public class MasterSelect implements Watcher {
     ...
     */
    void getLock(String path, String data, CreateMode createMode) throws IOException, KeeperException, InterruptedException {
        if (zk == null) {
            zk = this.createSession("vm.com:2181", 2000, this);
        }
    ...
    void exists(String path) throws KeeperException, InterruptedException, IOException {
        ...
        if (zk == null) {
            zk = this.createSession("vm.com:2181", 5000, this);
        }
        zk.exists(path, true);
    }
    ...
    public static void main(String[] args) throws IOException, InterruptedException {
        ...
        try {
            try {
                ...
                sample.exists(path);
                System.out.println("sample.exists(path)");
            }
